Pod::Spec.new do |s|
  s.name         = "customeSecurityZipArchive"
  s.version      = "1.4.2"
...
It can be used for iPhone application development, and cocoa on Mac OSX as well.
                    DESC
  s.homepage     = "https://github.com/RedCatKnight/SecurityZipArchive"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { "yunfeic" => "yunfeic@hotmail.com",}
  s.source       = { :git => 'https://github.com/RedCatKnight/SecurityZipArchive.git', :tag => '1.4.2' }
